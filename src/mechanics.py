        ...
        for recipe in self.recipes:
            ...
            if recipe_bases == essence_names:
                return Essence(
                    ...
                    color="Multicolor" # Default for confluence
                )
...
class AbilityGenerator:
    def generate(self, essence: Essence, stone: AwakeningStone, rank: str = "Iron") -> Ability:
        ...
        # Add flavor from color
        if essence.color and essence.color != "Unknown":
            description += f" It glows with a {essence.color} aura."
